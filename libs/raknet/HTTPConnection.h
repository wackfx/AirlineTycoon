...
/// Use Post() to send commands to the web server, and ProcessDataPacket() to update the connection with packets returned from TCPInterface that have the system
/// address of the web server This class will handle connecting and reconnecting as necessary.
///
