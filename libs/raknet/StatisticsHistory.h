...
class RAK_DLL_EXPORT StatisticsHistory {
  public:
    ...
    struct TimeAndValueQueue {
        ...
        static void MergeSets(const TimeAndValueQueue *lhs, SHDataCategory lhsDataCategory, const TimeAndValueQueue *rhs, SHDataCategory rhsDataCategory,
        ...
        void ResizeSampleSet(int approximateSamples, DataStructures::Queue<StatisticsHistory::TimeAndValue> &blendedSamples, SHDataCategory dataCategory,
                             Time timeClipStart = 0, Time timeClipEnd = 0);
