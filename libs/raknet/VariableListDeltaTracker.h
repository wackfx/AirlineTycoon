...
class VariableListDeltaTracker {
  public:
    ...
    template <class VarType> bool WriteVar(const VarType &varData) {
    ...
    template <class VarType> bool WriteVarToBitstream(const VarType &varData, RakNet::BitStream *bitStream) {
    ...
    template <class VarType> bool WriteVarToBitstream(const VarType &varData, RakNet::BitStream *bitStream, unsigned char *bArray, unsigned short writeOffset) {
    ...
    template <class VarType> static bool ReadVarFromBitstream(VarType &varData, RakNet::BitStream *bitStream) {
        bool wasWritten;
