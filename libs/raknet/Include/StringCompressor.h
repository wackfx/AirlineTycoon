...
/// \file
/// \brief \b Compresses/Decompresses ASCII strings and writes/reads them to BitStream class instances.  You can use this to easily serialize and deserialize
/// your own strings.
///
...
class RAK_DLL_EXPORT StringCompressor {
  public:
    ...
    /// yourself. \return the unique instance of the StringCompressor
    ...
    /// \param[in] languageID An identifier for the language / string table to generate the tree for.  English is automatically created with ID 0 in the
    /// constructor.
    ...
    /// not large enough, the string will be truncated. \param[in] input The bitstream containing the compressed string \param[in] languageID Which language to
    /// use
