...
void SetRoomVisited (SLONG PlayerNum, UBYTE RoomId)
{
    ...
    {
        if (WasAlreadyHere == 0) {
            if ((Sim.Players.Players[PlayerNum].WasInRoom[ROOM_BURO_A] == 0) &&
    ...
    {
        if (WasAlreadyHere == 0) {
            if ((Sim.Players.Players[PlayerNum].WasInRoom[ROOM_PERSONAL_A] == 0) &&
                    (Sim.Difficulty!=DIFF_TUTORIAL || Sim.Tutorial==9999)) {
    ...
    if (RoomId>=0 && RoomId<256)
    {
        ...
        if (WasAlreadyHere == 0)
        {
            if ((Sim.Players.Players[PlayerNum].WasInRoom[static_cast<SLONG>(RoomId)] == 0) &&
                    (Sim.Difficulty!=DIFF_TUTORIAL || Sim.Tutorial==9999)) {
...
CStdRaum::CStdRaum (BOOL bHandy, ULONG PlayerNum, const CString& GfxLibName, __int64 graficId)
{
    ...
    if (bHandy == 0) { Sim.Players.Players[static_cast<SLONG>(PlayerNum)].Messages.StopDialog ();
}
...
CStdRaum::~CStdRaum()
{
    ...
    if (PlayerNum>=0 && Sim.Players.Players.AnzEntries()>0 && (Sim.Players.Players[PlayerNum].DialogWin != nullptr) && Sim.Players.Players[PlayerNum].DialogWin!=this)
    {
...
//--------------------------------------------------------------------------------------------
BOOL CStdRaum::IsDialogOpen () const
{
    return static_cast<BOOL>(CurrentTextGroupId!=0 || DialogPartner!=TALKER_NONE || (bHandy != 0));
}
...
void CStdRaum::MakeSayWindow (BOOL TextAlign, ULONG SubId, const CString &String, SB_CFont *Normal)
{
    ...
    if (((Sim.Options.OptionTalking*Sim.Options.OptionMasterVolume) != 0) && Sim.Options.OptionDigiSound==1)
    {
        ...
        if (CreateSpeechSBFX (String, &SpeechFx, pl, &bAnyMissing) != 0)
        {
            ...
            if (bAnyMissing != 0) { TalkingSpeechFx=FALSE;
}
        }
...
void CStdRaum::MakeSayWindow (BOOL TextAlign, const char *GroupId, ULONG SubIdVon, ULONG SubIdBis, SLONG ParameterIndiziert, SB_CFont *Normal, SB_CFont *Highlight, ...)
{
    ...
    if (((Sim.Options.OptionTalking*Sim.Options.OptionMasterVolume) != 0) && SubIdVon==SubIdBis && Sim.Options.OptionDigiSound==1)
    {
        ...
        ReadyToStartSpeechFx=0;
        if (CreateSpeechSBFX (CString((char*)TmpString), &SpeechFx, pl) != 0)
        {
            if ((pSmackerPartner != nullptr) && TextAlign==0) {
                ReadyToStartSpeechFx=3;
            } else {
...
void CStdRaum::MakeNumberWindow (CString Text)
{
    ...
    else
    {
        ...
        if (DisplayThisBubble != 0) { NumberBitmapPos=XY(320-NumberBitmap.Size.x/2,440-NumberBitmap.Size.y-1);
    ...
    if (CurrentTextGroupId != 0U)
    {
        ...
        if (CurrentTextSubIdBis==0)
        {
            ...
            if (BubbleStyle==2)
            {
                ...
                if (RefreshAll != 0) { TextRect = BubbleRect  = PaintTextBubble (OnscreenBitmap, XY(50, BubblePos.y-Summe-8), XY(600, BubblePos.y+8), BubblePos+XY(0,8));
}
            ...
            {
                SLONG Summe = OnscreenBitmap.TryPrintAt (Optionen[0], *pFontNormal, TEC_FONT_LEFT, 90, 0, 560, 400);
                if (RefreshAll != 0) { TextRect = BubbleRect  = PaintTextBubble (OnscreenBitmap, XY(50, BubblePos.y-8), XY(600, BubblePos.y+Summe+8), BubblePos+XY(0,-8-1));
}
        ...
        else
        {
            ...
            if (TextAlign!=0) //unten, vom Spieler
            {
                ...
                if (pSmackerPartner != nullptr) { pSmackerPartner->SetDesiredMood (SPM_LISTENING);
}
                SmackerTimeToTalk = -1;
            }
            else //oben, vom gesprächspartner
            {
                ...
                if (RefreshAll != 0) { TextRect = TextRect = PaintTextBubble (OnscreenBitmap, XY(55, Summe), XY(585, BubblePos.y), BubblePos);
}
                OnscreenBitmap.PrintAt (Optionen[0], *pFontNormal, TEC_FONT_LEFT, 85, Summe, 555, 440);

                SmackerTimeToTalk = timeGetTime()+Optionen[0].GetLength()*2*50;
                if (pSmackerPartner != nullptr) { pSmackerPartner->SetDesiredMood (SPM_TALKING);
}
            }
        }
    }
...
void CStdRaum::StartDialog (SLONG DialogPartner, BOOL Medium, SLONG DialogPar1, SLONG DialogPar2, SLONG DialogPar3)
{
    ...
    switch (DialogPartner)
    {
        ...
        case TALKER_ARAB:
            ...
            {
                if (Medium != 0) {         MakeSayWindow (0, TOKEN_ARAB, 101, pFontPartner);
                } else if (TalkedToA != 0) { MakeSayWindow (0, TOKEN_ARAB, 102, pFontPartner);
        ...
        case TALKER_SABOTAGE:
            ...
            {
                if (Sim.Players.Players[PlayerNum].SpiderTrust != 0) { MakeSayWindow (0, TOKEN_SABOTAGE, 3002, pFontPartner);
            ...
            {
                if (TalkedToA != 0) { MakeSayWindow (0, TOKEN_SABOTAGE, 1022, pFontPartner);
        ...
        case TALKER_MECHANIKER:
            ...
            else if (DialogPar1==1)
            {
                if (Sim.Players.Players[PlayerNum].MechAngry==2)
                {
                    ...
                    if (Medium != 0) {         MakeSayWindow (0, TOKEN_MECH, 1001, pFontPartner);
                    } else if (TalkedToA != 0) { MakeSayWindow (0, TOKEN_MECH, 1002, pFontPartner);
        ...
        case TALKER_PERSONAL4a:
            ...
            {
                if (Sim.Players.Players[PlayerNum].SeligTrust != 0) { MakeSayWindow (0, TOKEN_JOBS, 301, pFontPartner);
            ...
            else if (TalkedToA != 0) { MakeSayWindow (0, TOKEN_JOBS, 102, pFontPartner);
        ...
        case TALKER_PERSONAL4b:
            ...
            else if (Medium != 0) {    MakeSayWindow (0, TOKEN_JOBS, 501, pFontPartner);
            } else if (TalkedToB != 0) { MakeSayWindow (0, TOKEN_JOBS, 503, pFontPartner);
        ...
        case TALKER_WERBUNG:
            ...
            {
                if (Sim.Players.Players[PlayerNum].WerbungTrust != 0) { MakeSayWindow (0, TOKEN_WERBUNG, 8002, pFontPartner);
        ...
        case TALKER_DUTYFREE:
            ...
            {
                if (Sim.Players.Players[PlayerNum].DutyTrust != 0) { MakeSayWindow (0, TOKEN_DUTYFREE, 802, pFontPartner);
        ...
        case TALKER_KIOSK:
            ...
            {
                if (Sim.Players.Players[PlayerNum].KioskTrust != 0) { MakeSayWindow (0, TOKEN_KIOSK, 1021, pFontPartner);
        ...
        case TALKER_COMPETITOR:
            ...
            if (DialogPar2==0) { MakeSayWindow (0, TOKEN_PLAYER, 1000+static_cast<int>(DialogMedium==MEDIUM_AIR), pFontPartner, (LPCSTR)Sim.Players.Players[DialogPar1].AirlineX);
            } else { MakeSayWindow (1, TOKEN_PLAYER, 1000+static_cast<int>(DialogMedium==MEDIUM_AIR), 1000+static_cast<int>(DialogMedium==MEDIUM_AIR), FALSE, &FontDialog, &FontDialogLight, (LPCSTR)Sim.Players.Players[Sim.localPlayer].AirlineX);
}
            break;
    }
}
...
void CStdRaum::StopDialog ()
{
    ...
    if (IsDialogOpen() != 0)
    {
        ...
        if (pSmackerPartner != nullptr) { pSmackerPartner->SetDesiredMood (SPM_IDLE);
}
        pSmackerPartner = nullptr;
            ...
            switch (CurrentMenu)
            {
                ...
                case MENU_PLAYERLIST:
                    if (CursorPos.IfIsWithin (32, 4, 204, 4+15*13))
                    {
                        ...
                        if (c>=6 && c<=8 && (Sim.Players.Players[c-6+static_cast<int>((c-6)>=PlayerNum)].IsOut == 0) && (Sim.Players.Players[c-6+static_cast<int>((c-6)>=PlayerNum)].HasItem (ITEM_HANDY) != 0))
                        {
                            CheckCursorHighlight (CursorPos, CRect (32, (CursorPos.y-4)/13*13+4, 204, (CursorPos.y-4)/13*13+4+15), ColorOfFontBlack);
                ...
                case MENU_AUSLANDSAUFTRAG:
                    ...
                    if ((CursorPos.y-7-26>=0 && CursorPos.x>=216 && CursorPos.x<=387 && (c>=0 && c<6 && (AuslandsAuftraege[MenuPar1].Auftraege[c].Praemie != 0))) || (c>=7 && c<7+6 && (AuslandsFrachten[MenuPar1].Fracht[c-7].Praemie != 0)) || c==7+7)
                    {
                    ...
                    else if (c!=MenuPar2 && c>=7 && c<7+6 && CursorPos.x>=216 && CursorPos.x<=387 && (AuslandsFrachten[MenuPar1].Fracht[c-7].Praemie != 0))
                    {
                        MenuRepaint ();
                ...
                case MENU_SELLPLANE:
                    if (CursorPos.IfIsWithin (216,6, 387,212))
                    {
                        ...
                        if (n>=0 && n<MenuDataTable.LineIndex.AnzEntries() && n-MenuPage<13 && (Sim.Players.Players[PlayerNum].Planes.IsInAlbum (MenuDataTable.LineIndex[n]) != 0))
                        {
                ...
                case MENU_BUYXPLANE:
                    if (CursorPos.IfIsWithin (216,6, 387,212))
                    {
                        ...
                        if (n>=0 && n<MenuDataTable.LineIndex.AnzEntries() && n-MenuPage<13 && (CurrentMenu==MENU_BUYXPLANE || (Sim.Players.Players[PlayerNum].Planes.IsInAlbum (MenuDataTable.LineIndex[n]) != 0)))
                        {
                            CheckCursorHighlight (CursorPos, CRect (32+180, n*13+23, 204+180, n*13+23+15), ColorOfFontBlack);
                            SetMouseLook (CURSOR_HOT, 0, -102, CurrentMenu, 0);
                        }
                ...
                case MENU_BROADCAST:
                    ...
                    for (c=0; c<4; c++) {
                        if (Sim.Players.Players[c].Owner==2) {
                            if (CursorPos.IfIsWithin (60+(c-static_cast<int>(c>Sim.localPlayer))*60, 80, 60+(c-static_cast<int>(c>Sim.localPlayer))*60+60, 80+60)) {
                ...
                case MENU_BANK:
                    if (CursorPos.IfIsWithin (111,159, 198,190)) { SetMouseLook (CURSOR_HOT, 4101+static_cast<int>(MenuPar2==1)*10, -102, MENU_BANK, 11);
                    } else if (CursorPos.IfIsWithin (204,156, 271,187)) { SetMouseLook (CURSOR_HOT, 4100+static_cast<int>(MenuPar2==1)*10, -102, MENU_BANK, 10);
}

                    CheckCursorHighlight (CursorPos, CRect (56, 81, 318, 96), ColorOfFontBlack, CURSOR_HOT, 4102+static_cast<int>(MenuPar2==1), -102, MENU_BANK, 12);
                    break;

                case MENU_AKTIE:
                case MENU_SETRENDITE:
                    if (CursorPos.IfIsWithin (237,125, 304,156)) { SetMouseLook (CURSOR_HOT, 4200+static_cast<int>(MenuPar2==1)*10+static_cast<int>(CurrentMenu==MENU_SETRENDITE)*100, -102, MENU_SETRENDITE, 10);
                    } else if (CursorPos.IfIsWithin (153,133, 208,159)) { SetMouseLook (CURSOR_HOT, 4201+static_cast<int>(MenuPar2==1)*10+static_cast<int>(CurrentMenu==MENU_SETRENDITE)*100, -102, MENU_SETRENDITE, 11);
}
...
void CStdRaum::PumpToolTips ()
{
    ...
    if (GlowEffects.AnzEntries() != 0)
    {
        ...
        if (Sim.Players.Players[Sim.localPlayer].GetRoom()==ROOM_GLOBE && (Sim.Players.Players[Sim.localPlayer].Blocks.IsInAlbum(ULONG(0)) != 0))
        {
            ...
            if ((dynamic_cast<CGlobe*>(this))->FensterVisible == 0) { Offset=XY(1000,1000);
}
        }
...
void CStdRaum::PostPaint ()
{
    ...
    if (bHandy==FALSE)
    {
        ...
        if ((bActive != 0) && (CurrentTextGroupId != 0U) && (bHandy==FALSE || TempScreenScrollV==0))
        {
            ...
            if (pSmackerPartner==nullptr || TextAlign!=0 || pSmackerPartner->GetMood()==SPM_TALKING || timeGetTime()>DWORD(SmackerTimeToTalk))
            {
                ...
                if ((pSmackerPartner != nullptr) && ReadyToStartSpeechFx==0 && pSmackerPartner->GetMood()==SPM_TALKING && ((timeGetTime()>DWORD(SmackerTimeToTalk) && TalkingSpeechFx==0) || ((TalkingSpeechFx != 0) && !SpeechFx.pFX->IsMouthOpen(400)) || TextAlign!=0)) { pSmackerPartner->SetDesiredMood (SPM_LISTENING);
}

                //Den Cursor-Highlight überprüfen:
                CheckHighlight (qPlayer.CursorPos);
            }
            else if ((pSmackerPartner != nullptr) && pSmackerPartner->GetMood()==SPM_LISTENING && (TalkingSpeechFx != 0) && (SpeechFx.pFX->IsMouthOpen(400) || (ReadyToStartSpeechFx != 0)) && TextAlign==0)
            {
                pSmackerPartner->SetDesiredMood (SPM_TALKING);
            }
            else
            ...
            if (pSmackerPartner==nullptr || TextAlign!=0 || (pSmackerPartner->GetMood()==SPM_TALKING || (pSmackerPartner->GetMood()==SPM_LISTENING && TextAlign==0 && ((status & DSBSTATUS_PLAYING) != 0U) && (TalkingSpeechFx != 0))) || timeGetTime()>DWORD(SmackerTimeToTalk))
            {
                ...
                if (OnscreenBitmap.pBitmap != nullptr) {
                    if (RoomBm.Size.x>0)
                    {
                        if (DisplayThisBubble != 0) { ColorFX.BlitWhiteTrans (TRUE, OnscreenBitmap.pBitmap, RoomBm.pBitmap, XY(WinP1.x+BubbleRect.left, WinP1.y+BubbleRect.top), &BubbleRect);
}
                    }
                    else
                    {
                        if (DisplayThisBubble != 0) { ColorFX.BlitWhiteTrans (TRUE, OnscreenBitmap.pBitmap, &PrimaryBm.PrimaryBm, XY(WinP1.x+BubbleRect.left, WinP1.y+BubbleRect.top), &BubbleRect);
}
                    }
}
            }
    ...
    if ((bActive != 0) && Sim.Gamestate==(GAMESTATE_PLAYING | GAMESTATE_WORKING))
    {
        ...
        if ((StatusCount>0 || (bNoSpeedyBar != 0) || (gBlendState>=0 && gBlendState<=8)) && PicBitmap.Size.y<=440)
        {
            ...
            if (gMousePosition.x>=634-24 && gMousePosition.y>=WinP2.y-StatusLineSizeY && gMousePosition.x<640 && gMousePosition.y<WinP2.y && (IsDialogOpen() == 0) && (MenuIsOpen() == 0))
            {
                ...
                else if ((gStatButton != 0) && timeGetTime()-gStatButtonTimer>400) { gStatButton=0;
}
            }
            else if (((Sim.IsTutorial != 0) || gStatButton==1) && gMousePosition.IfIsWithin (640-32-39, 440, 607, 479) && (IsDialogOpen() == 0) && (MenuIsOpen() == 0))
            {
        ...
        if (DialogPartner==TALKER_COMPETITOR)
        {
            if (timeGetTime()>DWORD(SmackerTimeToTalk) || TextAlign!=0 || ((TalkingSpeechFx>0 && !SpeechFx.pFX->IsMouthOpen(200)))) {
                PrimaryBm.FlipBlitFromT (BeraterBms[12+DialogPar1][static_cast<int>(DialogMedium==MEDIUM_HANDY)*4], XY(640-BeraterBms[12+DialogPar1][0].Size.x, 440-BeraterSlideY[12+DialogPar1+static_cast<int>(DialogMedium==MEDIUM_HANDY)*4]));
            } else {
                PrimaryBm.FlipBlitFromT (BeraterBms[12+DialogPar1]["\x0\x2\x1\x3\x2\x3\x0\x1\x2"[(timeGetTime()/50/3)&7]+static_cast<int>(DialogMedium==MEDIUM_HANDY)*4], XY(640-BeraterBms[12+DialogPar1][0].Size.x, 440-BeraterSlideY[12+DialogPar1+static_cast<int>(DialogMedium==MEDIUM_HANDY)*4]));
}

            //Gedankenblase für nachdenkende Netzwerkspieler:
            if (((IsDialogOpen() != 0) && pSmackerPartner==nullptr) || TextAlign!=0 || (pSmackerPartner->GetMood()==SPM_TALKING || (pSmackerPartner->GetMood()==SPM_LISTENING && TextAlign==0)))
            {
                if (OnscreenBitmap.pBitmap==nullptr)
                {
                    if (DisplayThisBubble != 0) {
                        ColorFX.BlitTrans (MoodBms[MoodPersonEmpty].pBitmap, &PrimaryBm.PrimaryBm, XY(640-BeraterBms[12+DialogPar1][0].Size.x, 440-BeraterSlideY[12+DialogPar1+static_cast<int>(DialogMedium==MEDIUM_HANDY)*4])-XY(-5,MoodBms[MoodPersonEmpty].Size.y), nullptr, 4);
}
                }
        ...
        if (CurrentMenu != MENU_NONE)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    XY p=MenuStartPos;
                    if (ZoomFromAirport != 0) { p-=qPlayer.ViewPos;
}
        ...
        if (qMessages.AktuellerBeraterTyp!=-1 && qMessages.BeraterWalkState==0 && PicBitmap.Size.y<=440)
        {
            ...
            if (qMessages.AktuellerBeraterTyp<100) { //Berater rechts, andere links
                PrimaryBm.BlitFromT (BeraterBms[qMessages.AktuelleBeraterBitmap]["\0\0\x1\0\x1\x1"[(qMessages.TalkPhase/3)%6]+(static_cast<int>(qMessages.BlinkCountdown>0)*BeraterBms[0].AnzEntries()/2)], 640-BeraterBms[qMessages.AktuelleBeraterBitmap][0].Size.x, qMessages.BeraterPosY);
            } else
                if (DontDisplayPlayer==-1 && (IsInBuro == 0)) {
                    PrimaryBm.BlitFromT (BeraterBms[qMessages.AktuelleBeraterBitmap]["\x0\x2\x1\x3\x2\x3\x0\x1\x2"[static_cast<int>(TalkingSpeechFx==0||SpeechFx.pFX->IsMouthOpen(200))*((qMessages.TalkPhase/3)&7)]+static_cast<int>(DialogMedium==MEDIUM_HANDY)*4], 0, qMessages.BeraterPosY);
                } else if ((qPlayer.Messages.IsDialogTalking<=0 || ((TalkingSpeechFx != 0) && !SpeechFx.pFX->IsMouthOpen(200))) && (IsInBuro != 0) && (IsDialogOpen() != 0)) {
                    (dynamic_cast<CBuero*>(this))->SP_Player.SetDesiredMood (SPM_LISTENING);
}
            ...
            if (qMessages.Messages[static_cast<SLONG>(0)].Message.GetLength()>0 && qMessages.AktuellerBeraterTyp<100)
            {
                ...
                if (qMessages.Messages[static_cast<SLONG>(0)].Mood!=-1)
                {
                    if (qMessages.Messages[static_cast<SLONG>(0)].BubbleType==1) {
                        ColorFX.BlitTrans (SmileyBms[qMessages.Messages[static_cast<SLONG>(0)].Mood].pBitmap, &PrimaryBm.PrimaryBm, XY(640-BeraterBms[qMessages.AktuelleBeraterBitmap][0].Size.x+BeraterSprechblasenOffset[qMessages.AktuelleBeraterBitmap].x-qMessages.SprechblaseBm.Size.x, qMessages.BeraterPosY+BeraterSprechblasenOffset[qMessages.AktuelleBeraterBitmap].y)+ XY(5,7), nullptr, 2);
                    } else if (qMessages.Messages[static_cast<SLONG>(0)].BubbleType==2) {
                        ColorFX.BlitTrans (SmileyBms[qMessages.Messages[static_cast<SLONG>(0)].Mood].pBitmap, &PrimaryBm.PrimaryBm, XY(640-BeraterBms[qMessages.AktuelleBeraterBitmap][0].Size.x+BeraterSprechblasenOffset[qMessages.AktuelleBeraterBitmap].x-qMessages.SprechblaseBm.Size.x, qMessages.BeraterPosY+BeraterSprechblasenOffset[qMessages.AktuelleBeraterBitmap].y)+ XY(7,18), nullptr, 2);
}
                }
            }
        }
    ...
    if (bHandy==FALSE)
    {
        if ((ForceRedrawTip != 0) || CurrentTipType!=LastTipType || LastTipId!=CurrentTipId || CurrentTipIdPar1!=LastTipIdPar1 || CurrentTipIdPar2!=LastTipIdPar2)
        {
            RepaintTip ();
        }
                ...
                case MENU_PERSONAL:
                    if (MouseClickId==MENU_PERSONAL)
                    {
                        ...
                        if (MenuPar2==1 && (Sim.Players.Players[PlayerNum].HasBerater (BERATERTYP_PERSONAL) != 0) && MenuPage>0 && (MouseClickPar1==-1 || MouseClickPar1==-2))
                        {
                            ...
                            {
                                //rausgeekelt:
                                Sim.Players.Players[PlayerNum].Messages.AddMessage (BERATERTYP_PERSONAL, bprintf (StandardTexte.GetS (TOKEN_ADVICE, 1004+Workers.Workers[MenuRemapper[MenuPage-1]].Geschlecht), Workers.Workers[MenuRemapper[MenuPage-1]].Name.c_str()), MESSAGE_COMMENT);
                            }
                            else if (Workers.Workers[MenuRemapper[MenuPage-1]].Employer==WORKER_JOBLESS)
                            {
                                if (Workers.Workers[MenuRemapper[MenuPage-1]].Typ<=BERATERTYP_SICHERHEIT && (Sim.Players.Players[PlayerNum].HasBerater (Workers.Workers[MenuRemapper[MenuPage-1]].Typ) != 0))
                                {
                                    ...
                                    } else if (Workers.Workers[MenuRemapper[MenuPage-1]].Talent<=Sim.Players.Players[PlayerNum].HasBerater (Workers.Workers[MenuRemapper[MenuPage-1]].Typ)) {
                                        Sim.Players.Players[PlayerNum].Messages.AddMessage (BERATERTYP_PERSONAL, StandardTexte.GetS (TOKEN_ADVICE, 1270), MESSAGE_COMMENT, SMILEY_BAD);
                                    } else {
                                        Sim.Players.Players[PlayerNum].Messages.AddMessage (BERATERTYP_PERSONAL, StandardTexte.GetS (TOKEN_ADVICE, 1271), MESSAGE_COMMENT, SMILEY_GOOD);
}
                                }
                                else if ((MenuRemapper[MenuPage-1]*7777%100)>Sim.Players.Players[PlayerNum].HasBerater (BERATERTYP_PERSONAL)) {
                                    Sim.Players.Players[PlayerNum].Messages.AddMessage (BERATERTYP_PERSONAL, StandardTexte.GetS (TOKEN_ADVICE, 1000), MESSAGE_COMMENT, SMILEY_NEUTRAL);
                                } else
                                {
                                    ...
                                    Sim.Players.Players[PlayerNum].Messages.AddMessage (BERATERTYP_PERSONAL, StandardTexte.GetS (TOKEN_ADVICE, n), MESSAGE_COMMENT, Smiley);
                                }
                            }
                            else
                            {
        ...
        if (ItemIndex<6 && Sim.bNoTime==FALSE) {
            switch (qPlayer.Items[ItemIndex])
            {
                ...
                case ITEM_FILOFAX:
                    ...
                    //Kalaschnikow:
                case ITEM_MG:
                    if ((Sim.Headlines.IsInteresting == 0) && qPlayer.GetRoom()==ROOM_KIOSK) { break;
}
                ...
                case ITEM_DART:
                    ...
                    if ((IsDialogOpen() == 0) && (MenuIsOpen() == 0) && qPlayer.GetRoom()==ROOM_WERBUNG && (Sim.Difficulty>=DIFF_NORMAL || Sim.Difficulty==DIFF_FREEGAME))
                    {
                ...
                case ITEM_PAPERCLIP:
                    if ((IsDialogOpen() == 0) && (MenuIsOpen() == 0) && qPlayer.GetRoom()==ROOM_FRACHT && Sim.ItemGlue==0 && (qPlayer.HasItem (ITEM_GLUE) == 0))
                    {
...
void CStdRaum::OnRButtonDown(UINT  /*nFlags*/, CPoint point)
{
    ...
    else if (CurrentMenu!=MENU_NONE && point.y<440)
    {
        if (CurrentMenu==MENU_PLAYERLIST || CurrentMenu==MENU_BRANCHLIST)
        {
            ...
            MenuPar1=2; //Handy
            MenuRepaint();
            if (Sim.Options.OptionEffekte != 0) { gMovePaper.Play(DSBPLAY_NOSTOP, Sim.Options.OptionEffekte*100/7);
}
            return;
        }
...
void CStdRaum::OnPaint(BOOL  /*bHandyDialog*/)
{
...

    {
        ...
        if (PicBitmap.Size.x != 0) { RoomBm.BlitFrom (PicBitmap, WinP1.x, WinP1.y);
}
        ...
        else
        {
            ...
            if (PlayerNum>=0 && (Sim.Players.Players[PlayerNum].DialogWin != nullptr) &&
                    (Sim.Players.Players[PlayerNum].DialogWin)->TempScreenScrollV==0 &&
                    (Sim.Players.Players[PlayerNum].DialogWin)->TempScreenScroll>=800 &&
                    (IsDialogOpen() == 0))
            {
    ...
    switch (CurrentTipType)
    {
        ...
        case TIP_AUFTRAG:
            DrawAuftragTip (PlayerNum,
                    TipBm,
                    static_cast<SBBMS*>(pTipOriginBm2),
                    pTipOriginBm,
                    &Sim.Players.Players[PlayerNum].Auftraege[CurrentTipId],
                    CurrentTipIdPar1,
                    CurrentTipIdPar2,
                    XY(0,0));
            break;
        ...
        case TIP_BUYAUFTRAG:
            DrawAuftragTip (PlayerNum,
                    ...
                    static_cast<SBBMS*>(pTipOriginBm2),
                    pTipOriginBm,
                    (CurrentTipId==-1)?nullptr:(&LastMinuteAuftraege.Auftraege[CurrentTipId]),
                    CurrentTipIdPar1,
                    CurrentTipIdPar2,
                    XY(0,0));
            break;
        ...
        case TIP_BUYAUFTRAGR:
            DrawAuftragTip (PlayerNum,
                    ...
                    static_cast<SBBMS*>(pTipOriginBm2),
                    pTipOriginBm,
                    (CurrentTipId==-1)?nullptr:(&ReisebueroAuftraege.Auftraege[CurrentTipId]),
                    CurrentTipIdPar1,
                    CurrentTipIdPar2,
                    XY(0,0));
            break;
        ...
        case TIP_BUYFRACHT:
            DrawFrachtTip (PlayerNum,
                    ...
                    static_cast<SBBMS*>(pTipOriginBm2),
                    pTipOriginBm,
                    (CurrentTipId==-1)?nullptr:(&gFrachten.Fracht[CurrentTipId]),
                    0,
                    CurrentTipIdPar1,
                    777,
                    CurrentTipIdPar2,
        ...
        case TIP_FRACHT:
            DrawFrachtTip (PlayerNum,
                    ...
                    static_cast<SBBMS*>(pTipOriginBm2),
                    pTipOriginBm,
                    &Sim.Players.Players[PlayerNum].Frachten[CurrentTipId],
                    0,
                    CurrentTipIdPar1,
                    777,
                    CurrentTipIdPar2,
...
void CStdRaum::MenuStart (SLONG MenuType, SLONG MenuPar1, SLONG MenuPar2, SLONG MenuPar3)
{
    ...
    switch (CurrentMenu)
    {
        ...
        case MENU_FILOFAX:
            ...
            if (MenuPar1==1) { pGfxMain->LoadLib (const_cast<char*>((LPCTSTR)FullFilename ("adressen.gli", GliPath)), &pMenuLib1, L_LOCMEM);
}
            if (MenuPar1==2) { pGfxMain->LoadLib (const_cast<char*>((LPCTSTR)FullFilename ("telefons.gli", GliPath)), &pMenuLib1, L_LOCMEM);
}
        ...
        case MENU_PERSONAL:
            ...
            if (MenuPageMax != 0) { MenuInfo/=MenuPageMax;
}
        ...
        case MENU_RENAMEEDITPLANE:
            {
                ...
                pGfxMain->LoadLib (const_cast<char*>((LPCTSTR)FullFilename ("rename.gli", GliPath)), &pMenuLib1, L_LOCMEM);
                MenuBms.ReSize(pMenuLib1, "MENU");
                if (qPlayer.GetRoom()==ROOM_EDITOR) { Optionen[0]=(dynamic_cast<CEditor*>(qPlayer.LocationWin))->Plane.Name;
}
                OnscreenBitmap.ReSize (MenuBms[0].Size);
            }
            break;
        ...
        case MENU_LETTERS:
            ...
            PaperTearFX.ReInit("pap2.raw");
            if (Sim.Options.OptionEffekte != 0) { PaperFX.Play(DSBPLAY_NOSTOP, Sim.Options.OptionEffekte*100/7);
}
            break;
        ...
        case MENU_SETRENDITE:
            if (CurrentMenu==MENU_SETRENDITE) { MenuInfo=Sim.Players.Players[PlayerNum].Dividende;
}
    ...
    switch (CurrentMenu)
    {
        case MENU_BANK:
            if (Sim.Players.Players[PlayerNum].GetRoom()==ROOM_BANK)
            {
                ...
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString64(Sim.Players.Players[PlayerNum].SollZins*Sim.Players.Players[PlayerNum].Credit/1200), qFontBankBlack, TEC_FONT_RIGHT, 58, 55, 270, 144);
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString64(Sim.Players.Players[PlayerNum].SollZins*Sim.Players.Players[PlayerNum].Credit/100), qFontBankBlack, TEC_FONT_RIGHT, 58, 65, 270, 144);
                ...
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString64(Sim.Players.Players[PlayerNum].Credit + MenuPar1), qFontBankBlack, TEC_FONT_RIGHT, 58, 103, 270, 144);
                ...
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString64(Sim.Players.Players[PlayerNum].SollZins*(Sim.Players.Players[PlayerNum].Credit + MenuPar1)/1200), qFontBankBlack, TEC_FONT_RIGHT, 58, 123, 270, 144);
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString64(Sim.Players.Players[PlayerNum].SollZins*(Sim.Players.Players[PlayerNum].Credit + MenuPar1)/100), qFontBankBlack, TEC_FONT_RIGHT, 58, 133, 270, 144);
        ...
        case MENU_KEROSIN:
            ...
            if (gLanguage==LANGUAGE_O) { OnscreenBitmap.PrintAt (bprintf ("%s Barris", (LPCTSTR)Insert1000erDots(Sim.Players.Players[PlayerNum].Tank)), FontSmallBlack, TEC_FONT_LEFT, 160, 58, 250, 320);
            } else {                       OnscreenBitmap.PrintAt (bprintf ("%s Barrel", (LPCTSTR)Insert1000erDots(Sim.Players.Players[PlayerNum].Tank)), FontSmallBlack, TEC_FONT_LEFT, 160, 58, 250, 320);
}
            if (gLanguage==LANGUAGE_O) { OnscreenBitmap.PrintAt (bprintf ("%s Barris (%li%%)", (LPCTSTR)Insert1000erDots(Sim.Players.Players[PlayerNum].TankInhalt), Sim.Players.Players[PlayerNum].TankInhalt*100/Sim.Players.Players[PlayerNum].Tank), FontSmallBlack, TEC_FONT_LEFT, 160, 71, 250, 320);
            } else {                       OnscreenBitmap.PrintAt (bprintf ("%s Barrel (%li%%)", (LPCTSTR)Insert1000erDots(Sim.Players.Players[PlayerNum].TankInhalt), Sim.Players.Players[PlayerNum].TankInhalt*100/Sim.Players.Players[PlayerNum].Tank), FontSmallBlack, TEC_FONT_LEFT, 160, 71, 250, 320);
}

            if (Sim.Players.Players[PlayerNum].TankInhalt != 0) {
                OnscreenBitmap.PrintAt (StandardTexte.GetS (TOKEN_TANK, 1010+Sim.Players.Players[PlayerNum].TankOpen), FontSmallBlack, TEC_FONT_LEFT, 18, 100, 250, 320);
            } else {
        ...
        case MENU_BRANCHLIST:
            {
                ...
                for (c=n=0; c<Cities.AnzEntries(); c++) {
                    if (Cities.IsInAlbum(c) != 0)
                    {
                        ...
                        if ((coop != 0) && c!=SLONG(Cities(Sim.HomeAirportId))) { n++;
}
                    }
}
        ...
        case MENU_PERSONAL:
            ...
            if (MenuPage==0)
            {
                ...
                if (MenuInfo != 0) { OnscreenBitmap.PrintAt (bprintf (StandardTexte.GetS (TOKEN_JOBS, 5010), MenuInfo), FontSmallBlack, TEC_FONT_LEFT, 40, 88, 250, 319);
}
            }
            else
            {
        ...
        case MENU_RENAMEEDITPLANE:
            {
                ...
                OnscreenBitmap.BlitFrom (MenuBms[0]);
                OnscreenBitmap.PrintAt (bprintf (StandardTexte.GetS (TOKEN_MISC, 3099), (LPCTSTR)CString((dynamic_cast<CEditor*>(qPlayer.LocationWin))->Plane.Name)), FontBigGrey, TEC_FONT_LEFT, 10, 10, 280, 190);
                OnscreenBitmap.PrintAt (StandardTexte.GetS (TOKEN_MISC, 3002), FontBigGrey, TEC_FONT_LEFT, 16, 160, 274, 190);
                OnscreenBitmap.PrintAt (StandardTexte.GetS (TOKEN_MISC, 3003), FontBigGrey, TEC_FONT_RIGHT, 16, 160, 274, 190);
                OnscreenBitmap.PrintAt (Optionen[0]+"_", FontSmallBlack, TEC_FONT_LEFT, 26, 141, 268, 155);
            }
        ...
        case MENU_BUYKEROSIN:
            if (Sim.Players.Players[PlayerNum].GetRoom()==ROOM_ARAB_AIR)
            {
                ...
                if (gLanguage==LANGUAGE_O) { OnscreenBitmap.PrintAt (bprintf ("%s barris", LPCTSTR(Insert1000erDots(Sim.Players.Players[PlayerNum].Tank))), FontSmallBlack, TEC_FONT_LEFT, 200, 50, 325, 113);
                } else {                       OnscreenBitmap.PrintAt (bprintf ("%s barrel", LPCTSTR(Insert1000erDots(Sim.Players.Players[PlayerNum].Tank))), FontSmallBlack, TEC_FONT_LEFT, 200, 50, 325, 113);
}

                if (gLanguage==LANGUAGE_O) { OnscreenBitmap.PrintAt (bprintf ("%s barris", LPCTSTR(Insert1000erDots(Sim.Players.Players[PlayerNum].TankInhalt))), FontSmallBlack, TEC_FONT_RIGHT, 56, 76, 200, 113);
                } else {                       OnscreenBitmap.PrintAt (bprintf ("%s barrel", LPCTSTR(Insert1000erDots(Sim.Players.Players[PlayerNum].TankInhalt))), FontSmallBlack, TEC_FONT_RIGHT, 56, 76, 200, 113);
}
                OnscreenBitmap.PrintAt (Einheiten[EINH_P].bString (Sim.Players.Players[PlayerNum].TankInhalt*100/_tank), FontSmallBlack, TEC_FONT_RIGHT, 56, 76, 236, 113);
                ...
                if (gLanguage==LANGUAGE_O) { OnscreenBitmap.PrintAt (bprintf ("%s barris", LPCTSTR(Insert1000erDots((MenuPar2+Sim.Players.Players[PlayerNum].TankInhalt)))), FontSmallBlack, TEC_FONT_RIGHT, 0, 102, 200, 160);
                } else {                       OnscreenBitmap.PrintAt (bprintf ("%s barrel", LPCTSTR(Insert1000erDots((MenuPar2+Sim.Players.Players[PlayerNum].TankInhalt)))), FontSmallBlack, TEC_FONT_RIGHT, 0, 102, 200, 160);
}
                OnscreenBitmap.PrintAt (Einheiten[EINH_P].bString ((MenuPar2+Sim.Players.Players[PlayerNum].TankInhalt)*100/_tank), FontSmallBlack, TEC_FONT_RIGHT, 56, 102, 236, 160);
        ...
        case MENU_SETRENDITE:
            if (Sim.Players.Players[PlayerNum].GetRoom()==ROOM_BANK)
            {
                ...
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString (MenuInfo*Sim.Players.Players[PlayerNum].AnzAktien), qFontBankBlack, TEC_FONT_RIGHT, 200, 50, 320, 113);
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString (MenuInfo*Sim.Players.Players[PlayerNum].AnzAktien/365), qFontBankBlack, TEC_FONT_RIGHT, 200, 63, 320, 113);
            }
            break;
        ...
        case MENU_AKTIE:
            if (Sim.Players.Players[PlayerNum].GetRoom()==ROOM_BANK)
            {
                ...
                if (MenuPar2==0) { neu=Sim.Players.Players[PlayerNum].OwnsAktien[MenuPar1]+MenuInfo;
                } else { neu=Sim.Players.Players[PlayerNum].OwnsAktien[MenuPar1]-MenuInfo;
}
                ...
                OnscreenBitmap.PrintAt (Einheiten[EINH_P].bString (SLONG(__int64(Sim.Players.Players[PlayerNum].OwnsAktien[MenuPar1])*100/Sim.Players.Players[MenuPar1].AnzAktien)), qFontBankBlack, TEC_FONT_LEFT, 200, 60, 325, 139);
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString64 (__int64(Sim.Players.Players[PlayerNum].OwnsAktien[MenuPar1])*SLONG(Sim.Players.Players[MenuPar1].Kurse[0])), qFontBankBlack, TEC_FONT_LEFT, 240, 60, 325, 139);
                ...
                OnscreenBitmap.PrintAt (Einheiten[EINH_DM].bString64 (__int64(Sim.Players.Players[PlayerNum].Money-(neu-Sim.Players.Players[PlayerNum].OwnsAktien[MenuPar1])*Sim.Players.Players[MenuPar1].Kurse[0])), qFontBankBlack, TEC_FONT_LEFT, 220, 111, 325, 139);
            }
            break;
                            ...
                            for (d=0; d<Sim.Players.Players[c].Planes.AnzEntries(); d++)
                            {
                                if (Sim.Players.Players[c].Planes.IsInAlbum(d) != 0)
                                {
                                    ...
                                    for (e=0; e<Plan->Flug.AnzEntries(); e++) {
                                        if ((Plan->Flug[e].ObjectType==1 || Plan->Flug[e].ObjectType==2) && (Plan->Flug[e].Landedate-Sim.Date==((Time+1)/24) && Plan->Flug[e].Landezeit==Time+1 && ((Plan->Flug[e].Gate!=-2 && Plan->Flug[e].NachCity==static_cast<ULONG>(Sim.HomeAirportId)) || (CheatShowAll != 0))))
                                        {
                                            //Blinkendes Etwas:
                    ...
                    for (c=0; c<Sim.Players.AnzPlayers; c++)
                    {
                        ...
                        for (d=0; d<Sim.Players.Players[c].Planes.AnzEntries(); d++)
                        {
                            if (Sim.Players.Players[c].Planes.IsInAlbum(d) != 0)
                            {
                                ...
                                //Für alle Flüge des Flugzeuges:
                                for (e=0; e<Plan->Flug.AnzEntries(); e++) {
                                    if ((Plan->Flug[e].ObjectType==1 || Plan->Flug[e].ObjectType==2) && (Plan->Flug[e].Startdate-Sim.Date==(Time/24) && Plan->Flug[e].Startzeit==Time && ((Plan->Flug[e].Gate!=-2 && Plan->Flug[e].VonCity==static_cast<ULONG>(Sim.HomeAirportId)) || (CheatShowAll != 0))))
                                    {
                                        //Blinkendes Etwas:
        ...
        case MENU_BRIEFING:
            {
                ...
                for (c=0; c<4; c++)
                {
                    ...
                    else
                    {
                        ...
                        if (tmp2 != 0) { OnscreenBitmap.PrintAt (Einheiten[EINH_P].bString (tmp/tmp2), FontBigGrey, TEC_FONT_RIGHT, p.x, p.y+15+87, p.x+240, 360);
}

                        bool Important=false;

                        if (qPlayer.HasWon() != 0) { Important=true;
}
                ...
                if (MenuPar1 == 0) { OnscreenBitmap.BlitFrom (MenuBms[13], 325,385);
}
            }
            break;
...
void CStdRaum::MenuPostPaint ()
{
    ...
    switch (CurrentMenu)
    {
        ...
        case MENU_BRIEFING:
            ...
            if (MenuPar1 == 0) { OnscreenBitmap.BlitFrom (MenuBms[13+static_cast<int>(MouseClickPar1==2)], 325,385);
}
            break;
    }
}
...
//--------------------------------------------------------------------------------------------
BOOL CStdRaum::MenuIsOpen () const
{
    return static_cast<BOOL>(CurrentMenu!=MENU_NONE);
}
            ...
            if (MouseClickArea==-101 && MouseClickId==MENU_FILOFAX)
            {
                ...
                if (MenuPar1==2) //Handy
                {
                    ...
                    if ((qPlayer.IsLocationInQueue(HandyRoomRemapper[MouseClickPar2]) == 0) && (qPlayer.TelephoneDown == 0))
                    {
                        ...
                        {
                            case ROOM_ARAB_AIR:
                                if ((Talkers.Talkers[TALKER_ARAB].IsBusy() != 0) || SLONG(Sim.Time)<timeArabOpen || Sim.Weekday==6) { goto phone_busy;
}
                            ...
                            case ROOM_AUFSICHT:
                                if (Talkers.Talkers[TALKER_BOSS].IsBusy() != 0) { goto phone_busy;
}
                            ...
                            case ROOM_MUSEUM:
                                if ((Talkers.Talkers[TALKER_MUSEUM].IsBusy() != 0) || (SLONG(Sim.Time)<timeMuseOpen || Sim.Weekday==5 || Sim.Weekday==6)) { goto phone_busy;
}
                            ...
                            case ROOM_MAKLER:
                                if ((Talkers.Talkers[TALKER_MAKLER].IsBusy() != 0) || SLONG(Sim.Time)>timeMaklClose) { goto phone_busy;
}
                            ...
                            case ROOM_WERKSTATT:
                                if (Talkers.Talkers[TALKER_MECHANIKER].IsBusy() != 0) { goto phone_busy;
}
                            ...
                            case ROOM_WERBUNG:
                                if ((Talkers.Talkers[TALKER_WERBUNG].IsBusy() != 0) || SLONG(Sim.Time)<timeWerbOpen || Sim.Weekday==5 || Sim.Weekday==6) { goto phone_busy;
}
                            ...
                            case ROOM_NASA:
                                if (Talkers.Talkers[TALKER_NASA].IsBusy() != 0) { goto phone_busy;
}
                            ...
                            case ROOM_BANK:
                                ...
                                {
                                    if (Talkers.Talkers[TALKER_BANKER2].IsBusy() != 0) { goto phone_busy;
}
...
phone_busy:
        ...
        case MENU_PLAYERLIST:
            ...
            if (MouseClickArea==-101 && MouseClickPar2!=Sim.localPlayer) {
                if ((MouseClickPar2>=0 && MouseClickPar2<=7 && (Sim.Players.Players[MouseClickPar2%4].IsOut == 0)) || (MouseClickPar2>=4 && MouseClickPar2<=7 && (Sim.Players.Players[MouseClickPar2-4].IsOut == 0)))
                {
                    MenuStop ();
                    Ferngespraech = FALSE;
                    ...
                    if ((bHandy != 0) && (qOther.HasItem (ITEM_HANDY) == 0)) { break;
}
        ...
        case MENU_PERSONAL:
            if (MouseClickId==MENU_PERSONAL)
            {
                ...
                if (MenuPar2==1 && (qPlayer.HasBerater (BERATERTYP_PERSONAL) != 0) && MenuPage>0 && (MouseClickPar1==-1 || MouseClickPar1==-2))
                {
                    ...
                    {
                        if (Workers.Workers[MenuRemapper[MenuPage-1]].Typ<=BERATERTYP_SICHERHEIT && (qPlayer.HasBerater (Workers.Workers[MenuRemapper[MenuPage-1]].Typ) != 0))
                        {
                            if (Workers.Workers[MenuRemapper[MenuPage-1]].Typ==BERATERTYP_PERSONAL) {
                ...
                if (Sim.bNetwork != 0) { qPlayer.NetUpdateWorkers ();
}
                MenuRepaint ();
            }
            break;
        ...
        case MENU_SABOTAGEPLANE:
            ...
            else if (Pos.IfIsWithin (216,6, 387,212))
            {
                ...
                if (n>=0 && n-MenuPage<13 && n<MenuDataTable.AnzRows && (Sim.Players.Players[qPlayer.ArabOpfer].Planes.IsInAlbum (MenuDataTable.LineIndex[n]) != 0))
                {
        ...
        case MENU_SABOTAGEROUTE:
            ...
            else if (Pos.IfIsWithin (216,6, 387,212))
            {
                ...
                if (n>=0 && n-MenuPage<13 && n<MenuDataTable.AnzRows && Sim.Players.Players[qPlayer.ArabOpfer].RentRouten.RentRouten[Routen(MenuDataTable.LineIndex[n])].Rang!=0)
                {
                    MenuPar1 = MenuDataTable.LineIndex[n];
            ...
            switch (MenuPar1)
            {
                ...
                case MENU_REQUEST_KILLROUTE:
                    if (MouseClickArea==-101 && MouseClickId==MENU_REQUEST && MouseClickPar1==1)
                    {
                        BLOCKS &qBlocks=qPlayer.Blocks;
                        for (SLONG c=0; c<Routen.AnzEntries(); c++) {
                            if ((qBlocks.IsInAlbum(c) != 0) && qBlocks[c].IndexB==0 && qBlocks[c].BlockTypeB==4 && (Routen(qBlocks[c].SelectedIdB)==ULONG(MenuPar2) || Routen(qBlocks[c].SelectedIdB)==ULONG(MenuPar3)))
                            {
                        ...
                        for (SLONG e=0; e<4; e++)
                        {
                            if ((Sim.Players.Players[e].IsOut == 0) && Sim.Players.Players[e].RentRouten.RentRouten[MenuPar2].Rang>qPlayer.RentRouten.RentRouten[MenuPar2].Rang) {
                                Sim.Players.Players[e].RentRouten.RentRouten[MenuPar2].Rang--;
}

                            if ((Sim.Players.Players[e].IsOut == 0) && Sim.Players.Players[e].RentRouten.RentRouten[MenuPar3].Rang>qPlayer.RentRouten.RentRouten[MenuPar3].Rang) {
                        ...
                        if ((qPlayer.LocationWin != nullptr) && (qPlayer.GetRoom()==ROOM_LAPTOP || qPlayer.GetRoom()==ROOM_GLOBE))
                        {
                            ...
                            if (qPlaner.CurrentPostItType==1 && (qPlaner.CurrentPostItId==static_cast<SLONG>(Routen.GetIdFromIndex(MenuPar2)) || qPlaner.CurrentPostItId==static_cast<SLONG>(Routen.GetIdFromIndex(MenuPar3)))) {
                ...
                case MENU_REQUEST_KILLITEM:
                    if (MouseClickArea==-101 && MouseClickId==MENU_REQUEST && MouseClickPar1==1)
                    {
                        ...
                        qPlayer.ReformIcons();
                        if (qPlayer.HasItem (ITEM_LAPTOP) == 0) { qPlayer.SecurityFlags &= ~(1<<1);
}
                    }
                    if (MouseClickArea==-101 && MouseClickId==MENU_REQUEST && MouseClickPar1>0) { MenuStop ();
}
            ...
            if (MouseClickArea==-102 && MouseClickId==MENU_SETRENDITE && MouseClickPar1==10)
            {
                if (MenuPar2==0) //kaufen
                {
                    ...
                    } else
                    {
                        ...
                        while (MenuInfo>0)
                        {
                            ...
                            Sim.Players.Players[MenuPar1].Kurse[0] =
                                Sim.Players.Players[MenuPar1].Kurse[0]* Sim.Players.Players[MenuPar1].AnzAktien/(Sim.Players.Players[MenuPar1].AnzAktien-min(1000,MenuInfo));
                ...
                else if (MenuPar2==1) //verkaufen
                {
                    ...
                    while (MenuInfo>0)
                    {
                        ...
                        Preis   +=__int64(__int64(min(1000,MenuInfo))*Sim.Players.Players[MenuPar1].Kurse[0]);
                        Sim.Players.Players[MenuPar1].Kurse[0] =
                            Sim.Players.Players[MenuPar1].Kurse[0]* (Sim.Players.Players[MenuPar1].AnzAktien-min(1000,MenuInfo))/Sim.Players.Players[MenuPar1].AnzAktien;
                        if (Sim.Players.Players[MenuPar1].Kurse[0]<0) {
                            Sim.Players.Players[MenuPar1].Kurse[0]=0;
}
                        MenuInfo-=min(1000,MenuInfo);
...
void CStdRaum::MenuRightClick (XY /*unused*/)
{
    ...
    if (CalculatorIsOpen != 0) { CalcStop (TRUE);
    } else { MenuStop ();
}
}
...
void CStdRaum::OnChar(UINT nChar, UINT /*unused*/, UINT /*unused*/)
{
    ...
    else if ((MenuIsOpen() != 0) && (CurrentMenu==MENU_RENAMEPLANE || CurrentMenu==MENU_RENAMEEDITPLANE || CurrentMenu==MENU_ENTERTCPIP || CurrentMenu==MENU_ENTERPROTECT || CurrentMenu==MENU_BROADCAST || CurrentMenu==MENU_CHAT))
    {
...
void CStdRaum::OnKeyDown(UINT nChar, UINT  /*nRepCnt*/, UINT  /*nFlags*/)
{
    ...
    if ((MenuIsOpen() != 0) && (CurrentMenu==MENU_RENAMEPLANE || CurrentMenu == MENU_RENAMEEDITPLANE || CurrentMenu==MENU_ENTERTCPIP || CurrentMenu==MENU_ENTERPROTECT || CurrentMenu==MENU_BROADCAST || CurrentMenu==MENU_CHAT))
    {
