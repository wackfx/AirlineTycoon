...
SLONG gWerbePrice[] = {1000, 10000, 50000, 100000, 250000, 2500000, 2000, 8000, 22000, 56000, 120000, 1400000, 5000, 93000, 290000, 870000, 4925000, 60000000};
...
const char *HallFilenames[] = {"kompletter Airport (%li-%li-%li-%li-%li-%li-%li-%li-%li-%li)",
                               "left%03li.dat",
                               "check%03li.dat",
                               "ofice%03li.dat",
                               "entry%03li.dat",
...
CRouten Routen;
BUFFER_V<CEinheit> Einheiten;
BUFFER_V<BUFFER_UWORD> GlobeMapper;
BUFFER_V<BUFFER_UBYTE> GlobeLight;
BUFFER_V<SLONG> GlobeMapperY;
BUFFER_V<UWORD> GlobeMixTab;
BUFFER_V<XY> GlobeWindows;
...
TABS TABLeft[] = {{TAB_STYLE_LEFT, 0}};
TABS TABRight[] = {{TAB_STYLE_RIGHT, 0}};
...
BUFFER_V<SBBM> TextBricks;
BUFFER_V<CString> TextBrickTexts;
...
SBBMS FlugplanBms;
BUFFER_V<SBBMS> FlugplanIconBms;
...
const SLONG MoodPersonRepairFC = 34;    // Kunde meint: Flugzeug ist Schrott
...
const SLONG MoodPersonTicketFC = 29;    // Kunde hat Ticket
