...
BOOL CStdRaum::PreLButtonDown(CPoint point) {
    ...
    if (DialogPartner != TALKER_NONE) {
        ...
        if ((bIsNetworkDialog != 0) && OnscreenBitmap.Size.y == 0 && !bJustDeletedTextWindow) {
            return (TRUE);
        }

        // if (CurrentTextSubIdVon!=CurrentTextSubIdBis && CurrentTextSubIdBis!=0 && TextAlign==1 && (Sim.Options.OptionTalking*Sim.Options.OptionDigiSound ||
        // bIsNetworkDialog) && gLanguage==LANGUAGE_D)
        if (CurrentTextSubIdVon != CurrentTextSubIdBis && CurrentTextSubIdBis != 0 && TextAlign == 1 &&
            (((Sim.Options.OptionTalking * Sim.Options.OptionDigiSound) != 0) || (bIsNetworkDialog != 0))) {
            LastClickId = -1;
        ...
        case TALKER_BANKER2:
            ...
            case 100: // Wie ist mein Kontostand?
                if (qPlayer.Credit > 0) {
                    MakeSayWindow(0, TOKEN_BANK, 110, pFontPartner, (LPCTSTR)Insert1000erDots64(qPlayer.Money), (LPCTSTR)Insert1000erDots64(qPlayer.Credit),
                                  qPlayer.SollZins);
                    MakeNumberWindow(TOKEN_BANK, 9990110, (LPCTSTR)Insert1000erDots64(qPlayer.Money), (LPCTSTR)Insert1000erDots64(qPlayer.Credit),
                                     qPlayer.SollZins);
                } else {
            ...
            case 101: // Will Kredit aufnehmen:
                ...
                if (tmp == 0) {
                    ...
                    MakeSayWindow(0, TOKEN_BANK, 150, pFontPartner);
                } else {
        ...
        case TALKER_BANKER1:
            ...
            case 1000: // Aktien kaufen
                if (DialogMedium == MEDIUM_HANDY) {
                    MakeSayWindow(0, TOKEN_BANK, 1200, pFontPartner);
                } else {
                    MakeSayWindow(0, TOKEN_BANK, 2000, pFontPartner);
                }
                break;
            case 2000:
            case 2016: {
                ...
                MakeSayWindow(1, TOKEN_BANK, 2010, 2014, 2, &FontDialog, &FontDialogLight, (LPCTSTR)Sim.Players.Players[0].AirlineX,
                              (LPCTSTR)Insert1000erDots(NumFree[0]), (LPCTSTR)Sim.Players.Players[1].AirlineX, (LPCTSTR)Insert1000erDots(NumFree[1]),
                              (LPCTSTR)Sim.Players.Players[2].AirlineX, (LPCTSTR)Insert1000erDots(NumFree[2]), (LPCTSTR)Sim.Players.Players[3].AirlineX,
                              (LPCTSTR)Insert1000erDots(NumFree[3]), 0);
            } break;
            case 2030:
            case 2031: {
                SLONG NumFree[4];
                ...
                MakeSayWindow(1, TOKEN_BANK, 2020, 2024, 2, &FontDialog, &FontDialogLight, (LPCTSTR)Sim.Players.Players[0].AirlineX,
                              (LPCTSTR)Insert1000erDots(NumFree[0]), (LPCTSTR)Sim.Players.Players[1].AirlineX, (LPCTSTR)Insert1000erDots(NumFree[1]),
                              (LPCTSTR)Sim.Players.Players[2].AirlineX, (LPCTSTR)Insert1000erDots(NumFree[2]), (LPCTSTR)Sim.Players.Players[3].AirlineX,
                              (LPCTSTR)Insert1000erDots(NumFree[3]), 0);
            } break;
            ...
            case 2020:
                if (Sim.Players.Players[0].IsOut != 0) {
                    ...
                    MenuDialogReEntryB = 2030;
                    MenuStart(MENU_AKTIE, 0, 0);
                }
                break;
            case 2011:
            case 2021:
            ...
            case 1001: // Aktien verkaufen:
                if (DialogMedium == MEDIUM_HANDY) {
                    ...
                    MakeSayWindow(0, TOKEN_BANK, 2100, pFontPartner);
                }
                break;
            case 2100:
            case 2116:
                MakeSayWindow(1, TOKEN_BANK, 2110, 2114, 2, &FontDialog, &FontDialogLight, (LPCTSTR)Sim.Players.Players[0].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[0]), (LPCTSTR)Sim.Players.Players[1].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[1]), (LPCTSTR)Sim.Players.Players[2].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[2]), (LPCTSTR)Sim.Players.Players[3].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[3]), 0);
                break;
            case 2130:
            case 2131:
                MakeSayWindow(1, TOKEN_BANK, 2120, 2124, 2, &FontDialog, &FontDialogLight, (LPCTSTR)Sim.Players.Players[0].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[0]), (LPCTSTR)Sim.Players.Players[1].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[1]), (LPCTSTR)Sim.Players.Players[2].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[2]), (LPCTSTR)Sim.Players.Players[3].AirlineX,
                              (LPCTSTR)Insert1000erDots(qPlayer.OwnsAktien[3]), 0);
            ...
            case 2120:
                if (Sim.Players.Players[0].IsOut != 0) {
                    ...
                    MenuDialogReEntryB = 2130;
                    MenuStart(MENU_AKTIE, 0, 1);
                }
                break;
            case 2111:
            case 2121:
            ...
            case 2522:
            case 2523:
                MakeSayWindow(1, TOKEN_BANK, 2510, 2514, 2, &FontDialog, &FontDialogLight, (LPCTSTR)Sim.Players.Players[0].AirlineX,
                              SLONG(Sim.Players.Players[0].IsOut != 0 ? SLONG(0) : qPlayer.OwnsAktien[0] * 100 / Sim.Players.Players[0].AnzAktien),
                              (LPCTSTR)Sim.Players.Players[1].AirlineX,
                              SLONG(Sim.Players.Players[1].IsOut != 0 ? SLONG(0) : qPlayer.OwnsAktien[1] * 100 / Sim.Players.Players[1].AnzAktien),
                              (LPCTSTR)Sim.Players.Players[2].AirlineX,
                              SLONG(Sim.Players.Players[2].IsOut != 0 ? SLONG(0) : qPlayer.OwnsAktien[2] * 100 / Sim.Players.Players[2].AnzAktien),
                              (LPCTSTR)Sim.Players.Players[3].AirlineX,
                              SLONG(Sim.Players.Players[3].IsOut != 0 ? SLONG(0) : qPlayer.OwnsAktien[3] * 100 / Sim.Players.Players[3].AnzAktien), 0);
                break;
            case 2510:
            case 2511:
            case 2512:
            ...
            case 3014: // 100%
            {
                ...
                break;
            case 3020:
                MakeSayWindow(0, TOKEN_BANK, 3021, pFontPartner);
                break;
            case 3021:
            ...
            case 3032: // Sicherheitsabfrage:
            {
                ...
                MakeNumberWindow(TOKEN_BANK, 9993040, (LPCTSTR)Insert1000erDots(DialogPar1), DialogPar2, static_cast<SLONG>(qPlayer.Kurse[0]),
                                 (LPCTSTR)Insert1000erDots(DialogPar1 * DialogPar2 / 10 / 100 * 100));
                break;
            case 3040:
        ...
        case TALKER_BOSS:
            ...
            case 30:
                ...
                // Eröffnungsdialog
            case 700:
                MakeSayWindow(0, TOKEN_BOSS, 701, pFontPartner);
                break;
            case 701:
            ...
            case 1000:
                MakeSayWindow(0, TOKEN_BOSS, 1001, pFontPartner);
                break;
            case 1100:
                MakeSayWindow(0, TOKEN_BOSS, 1101, pFontPartner);
                break;
            case 1200:
                MakeSayWindow(0, TOKEN_BOSS, 1201, pFontPartner);
                break;
            case 1201:
                MakeSayWindow(0, TOKEN_BOSS, 1202, pFontPartner);
                break;
            case 1300:
                MakeSayWindow(0, 1301,
                              bprintf(DialogTexte.GetS(TOKEN_BOSS, 1301), LPCTSTR(Cities[Sim.MissionCities[0]].Name),
                                      LPCTSTR(Cities[Sim.MissionCities[1]].Name), LPCTSTR(Cities[Sim.MissionCities[2]].Name),
                                      LPCTSTR(Cities[Sim.MissionCities[3]].Name), LPCTSTR(Cities[Sim.MissionCities[4]].Name),
                                      LPCTSTR(Cities[Sim.MissionCities[5]].Name), LPCTSTR(Cities[Sim.HomeAirportId].Name)),
                              pFontPartner);
                break;

            case 1610:
                MakeSayWindow(0, TOKEN_BOSS, 1611, pFontPartner);
                break;
            case 1620:
                MakeSayWindow(0, TOKEN_BOSS, 1621, pFontPartner);
                break;
            case 1630:
                MakeSayWindow(0, TOKEN_BOSS, 1631, pFontPartner);
                break;
            case 1640:
                MakeSayWindow(0, TOKEN_BOSS, 1641, pFontPartner);
                break;
            case 1650:
                MakeSayWindow(0, TOKEN_BOSS, 1651, pFontPartner);
                break;
            case 1660:
                MakeSayWindow(0, TOKEN_BOSS, 1661, pFontPartner);
                break;
            case 1670:
                MakeSayWindow(0, TOKEN_BOSS, 1671, pFontPartner);
                break;
            case 1680:
                MakeSayWindow(0, TOKEN_BOSS, 1681, pFontPartner);
                break;
            case 1690:
                MakeSayWindow(0, TOKEN_BOSS, 1691, pFontPartner);
                break;
            case 1700:
                MakeSayWindow(0, TOKEN_BOSS, 1701, pFontPartner);
                break;

            case 1810:
                MakeSayWindow(0, TOKEN_BOSS, 1811, pFontPartner);
                break;
            case 1820:
                MakeSayWindow(0, TOKEN_BOSS, 1821, pFontPartner);
                break;
            case 1830:
                MakeSayWindow(0, TOKEN_BOSS, 1831, pFontPartner);
                break;
            case 1840:
                MakeSayWindow(0, TOKEN_BOSS, 1841, pFontPartner);
                break;
            case 1850:
                MakeSayWindow(0, TOKEN_BOSS, 1851, pFontPartner);
                break;
            case 1860:
                MakeSayWindow(0, TOKEN_BOSS, 1861, pFontPartner);
                break;
            case 1870:
                MakeSayWindow(0, TOKEN_BOSS, 1871, pFontPartner);
                break;
            case 1880:
                MakeSayWindow(0, TOKEN_BOSS, 1881, pFontPartner);
                break;
            case 1890:
                MakeSayWindow(0, TOKEN_BOSS, 1891, pFontPartner);
                break;
            case 1900:
                MakeSayWindow(0, TOKEN_BOSS, 1901, pFontPartner);
                break;

            case 1301:
                MakeSayWindow(0, TOKEN_BOSS, 1302, pFontPartner);
                break;
            case 1302:
                MakeSayWindow(0, TOKEN_BOSS, 1303, pFontPartner);
                break;
            case 1400:
                MakeSayWindow(0, TOKEN_BOSS, 1401, pFontPartner);
                break;
            case 1500:
                MakeSayWindow(0, TOKEN_BOSS, 1501, pFontPartner);
                break;
            case 1501:
                MakeSayWindow(0, TOKEN_BOSS, 1502, pFontPartner);
                break;
            ...
            case 1401:
            case 1502:
                MakeSayWindow(0, TOKEN_BOSS, 1999, pFontPartner);
                break;
            case 1999:
                StopDialog();
...
#ifndef DEMO
            {
                ...
                if (Sim.Players.Players[d].HasWon() == 0) {
                    // Nein:
                    if (GetAnzBits(Sim.Players.Players[d].RocketFlags) == 0) {
                        goto _und_jetzt_weiter_mit_etc;
                    }
            ...
            case 9100: {
                ...
                for (SLONG c = 0; c < Sim.Players.Players.AnzEntries(); c++) {
                    if (Sim.Players.Players[c].IsOut == 0) {
                        ...
                        TmpStr += Sim.Players.Players[c].AirlineX + ": ";
                        TmpStr +=
                            Insert1000erDots(Sim.Players.Players[c].GetMissionRating()) + "/" + Insert1000erDots(Sim.Players.Players[c].GetMissionRating(true));
            ...
            _und_jetzt_weiter_mit_etc:
                ...
                if (DialogPar1 == 0 || DialogPar1 == 1) {
                    (dynamic_cast<CAufsicht *>(this))->ExitFromMiddle = 4;
                }
            ...
            case 20102: {
                ...
                if (Sim.Players.Players[DialogPar1].Image < -990) {
                    ...
                    if (tmp2 != 0) {
                        tmp /= tmp2;
                        if (tmp < 40) {
                            TmpStr += bprintf(DialogTexte.GetS(TOKEN_BOSS, 2030)) + Space;
                        } else if (tmp < 60) {
                            TmpStr += bprintf(DialogTexte.GetS(TOKEN_BOSS, 2031)) + Space;
                        } else if (tmp < 80) {
                            TmpStr += bprintf(DialogTexte.GetS(TOKEN_BOSS, 2032)) + Space;
                        } else if (tmp < 90) {
                            TmpStr += bprintf(DialogTexte.GetS(TOKEN_BOSS, 2033)) + Space;
                        } else {
                            switch (rand() % 3) {
                            case 0:
                    ...
                    if (tmp2 != 0) {
                        tmp /= tmp2;
                        if (tmp < 40) {
                            TmpStr += bprintf(DialogTexte.GetS(TOKEN_BOSS, 2040)) + Space;
                        } else if (tmp < 60) {
                            TmpStr += bprintf(DialogTexte.GetS(TOKEN_BOSS, 2041)) + Space;
                        } else if (tmp < 70) {
                            TmpStr += bprintf(DialogTexte.GetS(TOKEN_BOSS, 2042)) + Space;
                        } else if (tmp < 80) {
                            switch (rand() % 3) {
                            case 0:
            ...
            _ehemals_2080:
                ...
                if (DialogPar1 < Sim.SabotageActs.AnzEntries()) {
                    ...
                    if (c == DialogPar1) {
                        ...
                        MakeSayWindow(0, TOKEN_BOSS, 2050 + DialogPar2, pFontPartner,
                    ...
                    MakeSayWindow(0, TOKEN_BOSS, 2081, pFontPartner);
                }
            ...
            case 4050:
                if (Sim.Difficulty >= DIFF_ATFS) {
                    ...
                    MakeSayWindow(0, 4060 + Sim.Difficulty,
                                  bprintf(DialogTexte.GetS(TOKEN_BOSS, 4060 + Sim.Difficulty), LPCTSTR(Cities[Sim.HomeAirportId].Name),
                                          LPCTSTR(Cities[Sim.MissionCities[0]].Name), LPCTSTR(Cities[Sim.MissionCities[1]].Name),
                                          LPCTSTR(Cities[Sim.MissionCities[2]].Name), LPCTSTR(Cities[Sim.MissionCities[3]].Name),
                                          LPCTSTR(Cities[Sim.MissionCities[4]].Name), LPCTSTR(Cities[Sim.MissionCities[5]].Name)),
                                  pFontPartner);
                }
                break;
            case 4113:
            ...
            case 5000:
                ...
                break;
            case 5001:
                MakeSayWindow(0, TOKEN_BOSS, 5000 + Sim.Overtake * 10, pFontPartner, (LPCTSTR)(Sim.Players.Players[Sim.OvertakerAirline].AirlineX),
        ...
        case TALKER_MECHANIKER:
            ...
            case 1002:
                if (DialogMedium != 0) {
                    MakeSayWindow(1, TOKEN_MECH, 2100, 2102, FALSE, &FontDialog, &FontDialogLight);
                } else {
                    MakeSayWindow(1, TOKEN_MECH, 2000, 2006, FALSE, &FontDialog, &FontDialogLight);
                }
                break;

            case 2000: // Monolog, was er tun kann:
            case 2100:
                MakeSayWindow(0, TOKEN_MECH, 3000, pFontPartner);
                break;
            case 3000:
                MakeSayWindow(0, TOKEN_MECH, 3001, pFontPartner);
                break;
            case 3001:
                MakeSayWindow(0, TOKEN_MECH, 3002, pFontPartner);
                break;
            case 3002:
            ...
            case 2101: // Modus auswählen:
                MakeSayWindow(0, TOKEN_MECH, 4000 + qPlayer.MechMode, pFontPartner);
                break;
                break;
            case 4000:
            case 4001:
            ...
            case 2002: // Kosten-Frage:
                if (Sim.Date == 0) {
                    MakeSayWindow(0, TOKEN_MECH, 2500, pFontPartner);
                } else {
                    MakeSayWindow(0, TOKEN_MECH, 2501, pFontPartner);
                }
                break;
        ...
        case TALKER_MAKLER:
            ...
            case 170:
                if (DialogMedium == MEDIUM_HANDY) {
                    ...
                    MakeSayWindow(1, TOKEN_MAKLER, 100, 103, FALSE, &FontDialog, &FontDialogLight);
                }
                break;
            ...
            case static_cast<SLONG>(0xffffffff):
                break;
        ...
        case TALKER_PERSONAL4b:
            ...
            case 102: {
                ...
                for (c = 0; c < Workers.Workers.AnzEntries(); c++) {
                    if (Workers.Workers[c].Employer == WORKER_JOBLESS) {
                        if (Workers.Workers[c].Typ == WORKER_PILOT) {
                            n2++;
                        } else if (Workers.Workers[c].Typ == WORKER_STEWARDESS) {
                            n3++;
                        } else {
                            n1++;
                        }
                ...
                MakeSayWindow(1, TOKEN_JOBS, 200, 203, 3, &FontDialog, &FontDialogLight, n1, n2, n3);
            } break;
            ...
            case 602:
                if (DialogMedium == MEDIUM_HANDY) {
                    MakeSayWindow(0, TOKEN_JOBS, 900, pFontPartner);
                } else {
        ...
        case TALKER_WERBUNG:
            ...
            case 3000:
                ...
                break;
            case 3001:
                MakeSayWindow(1, TOKEN_WERBUNG, 4000, 4006, 1, &FontDialog, &FontDialogLight, (LPCTSTR)Insert1000erDots(gWerbePrice[DialogPar1 * 6 + 0]),
                              (LPCTSTR)Insert1000erDots(gWerbePrice[DialogPar1 * 6 + 1]), (LPCTSTR)Insert1000erDots(gWerbePrice[DialogPar1 * 6 + 2]),
                              (LPCTSTR)Insert1000erDots(gWerbePrice[DialogPar1 * 6 + 3]), (LPCTSTR)Insert1000erDots(gWerbePrice[DialogPar1 * 6 + 4]),
                              (LPCTSTR)Insert1000erDots(gWerbePrice[DialogPar1 * 6 + 5]));
                break;
        ...
        case TALKER_DUTYFREE:
            ...
            case 1001: {
                ...
                if (Sim.LaptopSoldTo != -1) {
                    tmp += CString(" ") + DialogTexte.GetS(TOKEN_DUTYFREE, 1003);
                }
        ...
        case TALKER_WORLD:
            switch (id) {
            case 1000:
                MakeSayWindow(1, TOKEN_WELT, 2000, 2000, 0, &FontDialog, &FontDialogLight, (LPCTSTR)qPlayer.AirlineX);
                break;

            case 2000:
                MakeSayWindow(1, TOKEN_WELT, 3000, 3002, 1, &FontDialog, &FontDialogLight, (LPCTSTR)Cities[DialogPar2].Name, (LPCTSTR)Cities[DialogPar2].Name,
                              NULL);
                break;

            case 5000:
                qPlayer.CalledCities[DialogPar2] = 1;
                MakeSayWindow(1, TOKEN_WELT, 3001, 3002, 1, &FontDialog, &FontDialogLight, (LPCTSTR)Cities[DialogPar2].Name, (LPCTSTR)Cities[DialogPar2].Name,
                              NULL);
                break;
        ...
        case TALKER_COMPETITOR: {
            if (Sim.Players.Players[DialogPar1].Owner == 2) {
                SIM::SendSimpleMessage(ATNET_DIALOG_SAY, Sim.Players.Players[DialogPar1].NetworkID, id);
            }
            ...
            case 1000:
                DialogPar2 ^= 1;
                if (DialogPar2 != 0) {
                    MakeSayWindow(1, TOKEN_PLAYER, 1200, 1200, 0, &FontDialog, &FontDialogLight, (LPCTSTR)qPlayer.AirlineX);
                } else {
            ...
            case 1200:
                ...
                if (DialogPar2 != 0) {
                    ...
                    if (qOther.Sympathie[Sim.localPlayer] < -400) {
                        MakeSayWindow(0, TOKEN_PLAYER, 1602, pFontPartner);
                    } else if (qOther.Sympathie[Sim.localPlayer] < -100) {
                        MakeSayWindow(0, TOKEN_PLAYER, 1601, pFontPartner);
                    } else {
                        MakeSayWindow(0, TOKEN_PLAYER, 1600, pFontPartner);
                    }
            ...
            case 2030:
                ...
                if (DialogPar2 != 0) {
                    ...
                    } else if (Summe > 1000000 || Sim.Date == 0) {
                        MakeSayWindow(0, TOKEN_PLAYER, 2501, pFontPartner);
                    } else if (Summe >= 0) {
                        MakeSayWindow(0, TOKEN_PLAYER, 2502, pFontPartner);
                    } else {
                        MakeSayWindow(0, TOKEN_PLAYER, 2503, pFontPartner);
                    }
                } else if (point != CPoint(0, 0)) {
                    SIM::SendSimpleMessage(ATNET_DIALOG_NEXT, qOther.NetworkID);
                }
        ...
        case TALKER_RICK:
            ...
            case 2000:
                // Neue Räume:
                if (Sim.Difficulty == DIFF_FINAL && Sim.Date == 1) {
                    MakeSayWindow(0, TOKEN_RICK, 2100, pFontPartner);
                } else if (Sim.Difficulty == DIFF_NORMAL && Sim.Date == 1) {
                    MakeSayWindow(0, TOKEN_RICK, 2101, pFontPartner);
                } else {
                    SLONG c = 0;
                        ...
                        if (PlaneTypes.IsInAlbum(c) != 0) {
                            if (PlaneTypes[c].FirstMissions == Sim.Difficulty || Sim.Difficulty == DIFF_FREEGAME) {
                                if (PlaneTypes[c].FirstDay == Sim.Date) {
                                    MakeSayWindow(0, 9999,
                                                  bprintf(DialogTexte.GetS(TOKEN_RICK, 2102), LPCTSTR(PlaneTypes[c].Name), LPCTSTR(PlaneTypes[c].Hersteller)),
                                                  pFontPartner);
                                    break;
                                }
                            }
                    ...
                    if (c < SLONG(PlaneTypes.AnzEntries())) {
                        break;
                    }

                    if (Sim.Date > 3 && (Sim.MoneyInBankTrash != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2104, pFontPartner);
                    } else if (Sim.Date > 15 && qPlayer.MechTrust == 0 && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2106, pFontPartner);
                    } else if ((qPlayer.HasBerater(BERATERTYP_INFO) == 0) && (PLAYER::HasBeraterApplied(BERATERTYP_INFO) != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2107, pFontPartner);
                    } else if ((qPlayer.HasBerater(BERATERTYP_FITNESS) == 0) && (PLAYER::HasBeraterApplied(BERATERTYP_FITNESS) != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2108, pFontPartner);
                    } else if ((qPlayer.HasBerater(BERATERTYP_SICHERHEIT) == 0) && (PLAYER::HasBeraterApplied(BERATERTYP_SICHERHEIT) != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2109, pFontPartner);
                    } else if ((qPlayer.HasBerater(BERATERTYP_AUFTRAG) == 0) && (PLAYER::HasBeraterApplied(BERATERTYP_AUFTRAG) != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2110, pFontPartner);
                    } else if ((qPlayer.HasBerater(BERATERTYP_GELD) == 0) && (PLAYER::HasBeraterApplied(BERATERTYP_GELD) != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2111, pFontPartner);
                    } else if ((qPlayer.HasBerater(BERATERTYP_PERSONAL) == 0) && (PLAYER::HasBeraterApplied(BERATERTYP_PERSONAL) != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2112, pFontPartner);
                    } else if ((qPlayer.HasBerater(BERATERTYP_ROUTE) == 0) && (PLAYER::HasBeraterApplied(BERATERTYP_ROUTE) != 0) && rand() % 5 == 0) {
                        MakeSayWindow(0, TOKEN_RICK, 2113, pFontPartner);
                    } else {
                            ...
                            if (PlaneTypes.IsInAlbum(c) != 0) {
                                if (PlaneTypes[c].FirstMissions == Sim.Difficulty || Sim.Difficulty == DIFF_FREEGAME) {
                                    if (PlaneTypes[c].FirstDay == Sim.Date + 3) {
                                        MakeSayWindow(
                                            0, 9999,
                                            bprintf(DialogTexte.GetS(TOKEN_RICK, 2103), LPCTSTR(PlaneTypes[c].Name), LPCTSTR(PlaneTypes[c].Hersteller)),
                                            pFontPartner);
                                        break;
                                    }
                                }
                        ...
                        // Kooperieren?
                        if (((Sim.Players.Players[(Sim.localPlayer + 1) % 4].Sympathie[Sim.localPlayer] > 0 &&
                              qPlayer.Kooperation[(Sim.localPlayer + 1) % 4] == 0 && (Sim.Players.Players[(Sim.localPlayer + 1) % 4].IsOut == 0)) ||
                             (Sim.Players.Players[(Sim.localPlayer + 2) % 4].Sympathie[Sim.localPlayer] > 0 &&
                              qPlayer.Kooperation[(Sim.localPlayer + 2) % 4] == 0 && (Sim.Players.Players[(Sim.localPlayer + 2) % 4].IsOut == 0)) ||
                             (Sim.Players.Players[(Sim.localPlayer + 3) % 4].Sympathie[Sim.localPlayer] > 0 &&
                              qPlayer.Kooperation[(Sim.localPlayer + 3) % 4] == 0 && (Sim.Players.Players[(Sim.localPlayer + 3) % 4].IsOut == 0))) &&
                            rand() % 5 == 0) {
                            MakeSayWindow(0, TOKEN_RICK, 2114, pFontPartner);
                        } else {
                            for (c = 0; c < SLONG(qPlayer.Planes.AnzEntries()); c++) {
                                if ((qPlayer.Planes.IsInAlbum(c) != 0) && SLONG(qPlayer.Planes[c].TargetZustand) - SLONG(qPlayer.Planes[c].WorstZustand) > 20 &&
                                    rand() % 5 == 0) {
                            ...
                            if (c < SLONG(qPlayer.Planes.AnzEntries())) {
                                break;
                            }

                            // Kaum Aktien von sich selber/Neue Aktien:
                            if (qPlayer.OwnsAktien[Sim.localPlayer] < qPlayer.AnzAktien / 2 && rand() % 5 == 0) {
                                MakeSayWindow(0, TOKEN_RICK, 2117, pFontPartner);
                            } else if (((qPlayer.MaxAktien - qPlayer.AnzAktien) / 100 * 100) >= 10000 && rand() % 5 == 0) {
                                MakeSayWindow(0, TOKEN_RICK, 2118, pFontPartner);
                            } else if (qPlayer.Dividende < 5 && rand() % 5 == 0) {
                                MakeSayWindow(0, TOKEN_RICK, 2119, pFontPartner);
                            } else if (qPlayer.Money > 30000000 && rand() % 5 == 0) {
                                MakeSayWindow(0, TOKEN_RICK, 2120, pFontPartner);

                                // Tote Hose:
                            } else {
                                MakeSayWindow(0, TOKEN_RICK, 2199, pFontPartner);
                            }
                        }
                    }
                }
